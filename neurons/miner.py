...
RUNTIME_MODEL_RELATIVE_PATH = Path("weights") / "gen22_hybrid_full_0.0595.pt"
...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            defaults={
                "model_name": "gen22full3",
                "model_version": "22.1",
                "framework": "pytorch-checkpoint",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-gen22full3",
                "repo_commit": git_commit,
                "notes": "gen22 hybrid full checkpoint scored with deterministic vote101 sampling, minichunk threshold 0.0595, and parent cutoff 66/101.",
                "open_source": True,
                "inference_mode": "local",
                "training_data_statement": "Uses the gen22_hybrid_full_0.0595 checkpoint with vote101 runtime aggregation, minichunk threshold 0.0595, and parent cutoff 66/101.",
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        decision_threshold = 66.0 / 101.0
        synapse.predictions = [s >= decision_threshold for s in scores]
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with scorer gen22full3.")
        return synapse
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: gen22full3"
            )
            time.sleep(60)
